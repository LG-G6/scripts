...
sftp bernardobas@frs.sourceforge.net:/home/pfs/project/lg-g6/Archive/LineageOS\ 18.1/US997/ <<< $'put *.*'
...
sftp bernardobas@frs.sourceforge.net:/home/pfs/project/lg-g6/Archive/LineageOS\ 18.1/H872/ <<< $'put *.*'
...
sftp bernardobas@frs.sourceforge.net:/home/pfs/project/lg-g6/Archive/LineageOS\ 18.1/H870DS/ <<< $'put *.*'
...
sftp bernardobas@frs.sourceforge.net:/home/pfs/project/lg-g6/Archive/LineageOS\ 18.1/H870/ <<< $'put *.*'
